...
with tab6:
   ...
   with col1:
      st.markdown("<h1 style='text-align: center; margin-bottom: font-size: 5rem,1rem; color: #FFFFFF;'>✅", unsafe_allow_html=True)
      if total_hours_completed >= 0:
         st.markdown("<h1 style='text-align: center; margin-bottom: 1rem; font-size: 5rem,color: #000000;'> UNLOCKED 🔓", unsafe_allow_html=True)
