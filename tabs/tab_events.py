...
def ui_events_tab():
    ...
    st.header("Events & Recurring Schedule", help="This tab is where you can manage your compulsory one-time events or recurring schedules. Add new events/schedules, view existing ones, and delete them as needed!")
